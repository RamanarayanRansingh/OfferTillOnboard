const __vite__fileDeps=["./index-6xE_NnPI.js","./index-22Vzr9F4.js","./index-Dk01HkZL.js","./index-DmlsizMP.css","./Check-CZUQOzJl.js","./Copy-B6RcHnoK.js","./Index-krYyDV7d.js","./Index-BEyjvDG_.css","./Button-Da__8woF.js","./Button-CTZL5Nos.css","./Download-DVtk-Jv3.js","./DownloadLink-81FY0x02.js","./file-url-DRq49uk5.js","./Code-DGNrTu_I.js","./BlockLabel-CJgqtbDh.js","./Empty-B8B2kE4f.js","./Example-Wp-_4AVX.js","./Example-oomIF0ca.css","./index-BlywGFbz.js","./index-CONGcp5H.js","./index-CrWIcN2r.js","./index-1kg4_yNV.js","./frontmatter-BvqOa3Vm.js","./yaml-DsCXHVTH.js","./index-DaP3dj9F.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import{_ as ce}from"./index-Dk01HkZL.js";import{C as ra}from"./Check-CZUQOzJl.js";import{C as sf}from"./Copy-B6RcHnoK.js";import{S as rf}from"./Index-krYyDV7d.js";import{f as Zr,B as of}from"./Button-Da__8woF.js";import{D as lf}from"./Download-DVtk-Jv3.js";import{D as af}from"./DownloadLink-81FY0x02.js";import{C as oa}from"./Code-DGNrTu_I.js";import{B as hf}from"./BlockLabel-CJgqtbDh.js";import{E as cf}from"./Empty-B8B2kE4f.js";import ff from"./Example-Wp-_4AVX.js";class V{constructor(){}lineAt(e){if(e<0||e>this.length)throw new RangeError(`Invalid position ${e} in document of length ${this.length}`);return this.lineInner(e,!1,1,0)}line(e){if(e<1||e>this.lines)throw new RangeError(`Invalid line number ${e} in ${this.lines}-line document`);return this.lineInner(e,!0,1,0)}replace(e,t,i){let s=[];return this.decompose(0,e,s,2),i.length&&i.decompose(0,i.length,s,3),this.decompose(t,this.length,s,1),je.from(s,this.length-(t-e)+i.length)}append(e){return this.replace(this.length,this.length,e)}slice(e,t=this.length){let i=[];return this.decompose(e,t,i,0),je.from(i,t-e)}eq(e){if(e==this)return!0;if(e.length!=this.length||e.lines!=this.lines)return!1;let t=this.scanIdentical(e,1),i=this.length-this.scanIdentical(e,-1),s=new gi(this),r=new gi(e);for(let o=t,l=t;;){if(s.next(o),r.next(o),o=0,s.lineBreak!=r.lineBreak||s.done!=r.done||s.value!=r.value)return!1;if(l+=s.value.length,s.done||l>=i)return!0}}iter(e=1){return new gi(this,e)}iterRange(e,t=this.length){return new la(this,e,t)}iterLines(e,t){let i;if(e==null)i=this.iter();else{t==null&&(t=this.lines+1);let s=this.line(e).from;i=this.iterRange(s,Math.max(s,t==this.lines+1?this.length:t<=1?0:this.line(t-1).to))}return new aa(i)}toString(){return this.sliceString(0)}toJSON(){let e=[];return this.flatten(e),e}static of(e){if(e.length==0)throw new RangeError("A document must have at least one line");return e.length==1&&!e[0]?V.empty:e.length<=32?new X(e):je.from(X.split(e,[]))}}class X extends V{constructor(e,t=uf(e)){super(),this.text=e,this.length=t}get lines(){return this.text.length}get children(){return null}lineInner(e,t,i,s){for(let r=0;;r++){let o=this.text[r],l=s+o.length;if((t?i:l)>=e)return new df(s,l,i,o);s=l+1,i++}}decompose(e,t,i,s){let r=e<=0&&t>=this.length?this:new X(eo(this.text,e,t),Math.min(t,this.length)-Math.max(0,e));if(s&1){let o=i.pop(),l=rn(r.text,o.text.slice(),0,r.length);if(l.length<=32)i.push(new X(l,o.length+r.length));else{let a=l.length>>1;i.push(new X(l.slice(0,a)),new X(l.slice(a)))}}else i.push(r)}replace(e,t,i){if(!(i instanceof X))return super.replace(e,t,i);let s=rn(this.text,rn(i.text,eo(this.text,0,e)),t),r=this.length+i.length-(t-e);return s.length<=32?new X(s,r):je.from(X.split(s,[]),r)}sliceString(e,t=this.length,i=`
